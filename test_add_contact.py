...
class test_add_contact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, Contact(firstname="Emme", middlename="Anne", lastname="Imme", nickname="Onne", title="Engineer",
                            ...
                            website="zaggfa.co.uk", birthyear="1952", annivyear="1985", address2="Selby 72",
                            homephone2="555 555 555", notes="Chief Engineer"))
        self.return_to_home_contact_page(wd)
        self.logout(wd)
    ...
    def test_add__empty_contact(self):
        ...
        self.create_contact(wd, Contact(firstname="", middlename="", lastname="", nickname="", title="",
                            ...
                            website="", birthyear="", annivyear="", address2="",
                            homephone2="", notes=""))
        self.return_to_home_contact_page(wd)
        self.logout(wd)
    ...
    def return_to_home_contact_page(self, wd):
